...
namespace Bolt.AdvancedTutorial
{
    ...
    public class PlayerMotor : MonoBehaviour
    {
        ...
        public void SetState(Vector3 position, Vector3 localPosition, Vector3 velocity, bool isGrounded, int jumpFrames)
        {
            // assign new state
            ...
            {
                if (_state.position != Vector3.zero && Vector3.Distance(_state.position, _state.localPosition) > 2f)
                    transform.localPosition = _state.localPosition;
